...
class JiraTestCase(unittest.TestCase):
    ...
    This is the method that is called before each test is run.

    Where possible follow the:

        GIVEN - where you set up any pre-requisites e.g. the expectated result
    ...
    def setUp(self) -> None:
        """
        This is called before each test. If you want to redefine parts of this test,
        Run `JiraTestCase.setUp(self) in your custom setUp().
        """
